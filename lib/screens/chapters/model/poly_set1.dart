...
part 'poly_set1.g.dart';

@JsonSerializable(createToJson: true)
class PolynomialSet1 {
  Data? data;
  String? status;
  int? statusCode;
  String? message;
  ...
  factory PolynomialSet1.fromJson(Map<String, dynamic> Json) =>
      _$PolynomialSet1FromJson(Json);
  Map<String, dynamic> toJson() => _$PolynomialSet1ToJson(this);
}
