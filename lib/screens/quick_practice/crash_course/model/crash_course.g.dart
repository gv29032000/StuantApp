...
part of 'crash_course.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PolyCrashCourse _$PolyCrashCourseFromJson(Map<String, dynamic> json) =>
    PolyCrashCourse(
      data: json['data'] == null
          ? null
...
Map<String, dynamic> _$PolyCrashCourseToJson(PolyCrashCourse instance) =>
    <String, dynamic>{
      'data': instance.data,
...
Data _$DataFromJson(Map<String, dynamic> json) => Data(
      ...
      questions: (json['questions'] as List<dynamic>?)
          ?.map((e) => Questions1.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Questions1 _$Questions1FromJson(Map<String, dynamic> json) => Questions1(
